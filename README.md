...
- [WHO](https://www.who.int/) for hazard classification data
- [PubChem](https://pubchem.ncbi.nlm.nih.gov/) for chemical properties
- [Kenya PCPB](https://www.pcpb.go.ke/) for regulatory information
